...
from PyQt4.QtGui import QMainWindow, QHBoxLayout, QWidget, QDockWidget
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.console = QDockWidget('Console - PyChakura2.7', self)
    ...
    def _setup_ui(self):
        ...
        self.console.setAllowedAreas(Qt.NoDockWidgetArea)
